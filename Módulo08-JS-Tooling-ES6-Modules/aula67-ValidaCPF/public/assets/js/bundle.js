...
var ValidaCPF = /*#__PURE__*/function () {
  ...
  _createClass(ValidaCPF, [{
    ...
    } // quando não tenho nenhum this em um método, ele pode se tornar estático
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root {\n  --primary-color: rgb(17, 86, 102);\n  --primary-color-darker: rgb(9, 48, 56);\n}\n\n* {\n  box-sizing: border-box;\n  outline: 0;\n}\n\nbody {\n  margin: 0;\n  padding: 0;\n  background: var(--primary-color);\n  font-family: 'Open sans', sans-serif;\n  font-size: 1.3em;\n  line-height: 1.5em;\n}\n\n.container {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  max-width: 640px;\n  margin: 50px auto;\n  background: #fff;\n  padding: 20px;\n  border-radius: 10px;\n}\n\n.display-cpf {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 1.3em;\n  color: var(--primary-color);\n  margin-bottom: 20px;\n  border: 2px solid var(--primary-color-darker);\n  border-radius: 10px;\n  width: 220px;\n  height: 40px;\n}\n\nbutton {\n  padding: 5px 10px;\n  font-size: 1em;\n  border-radius: 10px;\n  background-color: #fff;\n  color: var(--primary-color-darker);\n  margin-bottom: 10px;\n}\n\nbutton:hover {\n  color: #fff;\n  background-color: var(--primary-color);\n  cursor: pointer;\n}\n\n.cpf-validado {\n  display: flex;\n  text-align: center;\n  margin-bottom: 5px;\n}\n\n.resultado-cpf {\n  font-size: 0.8em;\n  margin-bottom: 10px;\n  color: var(--primary-color-darker);\n}\n\n.valido {\n  color: green;\n}\n\n.invalido {\n  color: red;\n}\n", "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AACA;EACE,iCAAiC;EACjC,sCAAsC;AACxC;;AAEA;EACE,sBAAsB;EACtB,UAAU;AACZ;;AAEA;EACE,SAAS;EACT,UAAU;EACV,gCAAgC;EAChC,oCAAoC;EACpC,gBAAgB;EAChB,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,uBAAuB;EACvB,gBAAgB;EAChB,iBAAiB;EACjB,gBAAgB;EAChB,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,gBAAgB;EAChB,2BAA2B;EAC3B,mBAAmB;EACnB,6CAA6C;EAC7C,mBAAmB;EACnB,YAAY;EACZ,YAAY;AACd;;AAEA;EACE,iBAAiB;EACjB,cAAc;EACd,mBAAmB;EACnB,sBAAsB;EACtB,kCAAkC;EAClC,mBAAmB;AACrB;;AAEA;EACE,WAAW;EACX,sCAAsC;EACtC,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,kBAAkB;EAClB,kBAAkB;AACpB;;AAEA;EACE,gBAAgB;EAChB,mBAAmB;EACnB,kCAAkC;AACpC;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,UAAU;AACZ","sourcesContent":["@import url('https://fonts.googleapis.com/css?family=Open+Sans:400,700&display=swap');\n:root {\n  --primary-color: rgb(17, 86, 102);\n  --primary-color-darker: rgb(9, 48, 56);\n}\n\n* {\n  box-sizing: border-box;\n  outline: 0;\n}\n\nbody {\n  margin: 0;\n  padding: 0;\n  background: var(--primary-color);\n  font-family: 'Open sans', sans-serif;\n  font-size: 1.3em;\n  line-height: 1.5em;\n}\n\n.container {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  max-width: 640px;\n  margin: 50px auto;\n  background: #fff;\n  padding: 20px;\n  border-radius: 10px;\n}\n\n.display-cpf {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 1.3em;\n  color: var(--primary-color);\n  margin-bottom: 20px;\n  border: 2px solid var(--primary-color-darker);\n  border-radius: 10px;\n  width: 220px;\n  height: 40px;\n}\n\nbutton {\n  padding: 5px 10px;\n  font-size: 1em;\n  border-radius: 10px;\n  background-color: #fff;\n  color: var(--primary-color-darker);\n  margin-bottom: 10px;\n}\n\nbutton:hover {\n  color: #fff;\n  background-color: var(--primary-color);\n  cursor: pointer;\n}\n\n.cpf-validado {\n  display: flex;\n  text-align: center;\n  margin-bottom: 5px;\n}\n\n.resultado-cpf {\n  font-size: 0.8em;\n  margin-bottom: 10px;\n  color: var(--primary-color-darker);\n}\n\n.valido {\n  color: green;\n}\n\n.invalido {\n  color: red;\n}\n"],"sourceRoot":""}]);
// Exports
...
document.addEventListener('click', function (e) {
  ...
  if (el.classList.contains('validar')) {
    var cpfText = document.querySelector('.cpf-validado');
    var resultCpf = document.querySelector('.resultado-cpf');
    var cpfValida = new _modules_ValidaCPF__WEBPACK_IMPORTED_MODULE_2__["default"](cpfText.value).valida();
